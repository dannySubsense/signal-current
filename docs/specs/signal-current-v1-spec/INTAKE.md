...
- `docs/specs/00-source-inventory-reconciliation.md` (the 58-row Reconciliation Matrix, Status "Specification-phase working baseline," 2026-09-04) is the authoritative synthesis of all prior chats/research inputs and is the primary source this sprint's documents must trace to.
